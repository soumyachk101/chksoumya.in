        ...
        return (
            <div className="min-h-screen flex items-center justify-center text-pencil">
                <div className="text-center">
                    ...
                    <Link to="/#certificates" className="text-accent font-sans font-bold hover:underline">Back to Portfolio</Link>
                </div>
            </div>
        );
    }
    ...
    return (
        <section className="min-h-screen py-20 px-4 sm:px-6 lg:px-8 relative overflow-hidden">
            <div className="max-w-7xl mx-auto relative z-10">
                {/* Header */}
                <div className="mb-16">
                    <Link to="/#certificates" className="inline-flex items-center text-pencil font-sans font-bold hover:text-accent transition-colors mb-8 group bg-white border-2 border-pencil border-wobbly px-4 py-2 shadow-hard transform -rotate-1 hover:rotate-0">
                                ...
                                >
                                    ...
                                    >
                                        ...
                                        <a
                                            ...
                                            className="inline-flex items-center text-sm font-sans font-bold text-pencil hover:text-paper bg-white border-2 border-pencil border-wobbly px-4 py-2 hover:bg-pencil transition-all shadow-[2px_2px_0px_0px_#2d2d2d] w-fit mt-auto"
                                        >
